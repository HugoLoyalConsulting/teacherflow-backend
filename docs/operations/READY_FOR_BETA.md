...
- Abra: [`GOOGLE_OAUTH_SETUP.md`](./GOOGLE_OAUTH_SETUP.md)
- Siga os passos
...
Consulte:
- [`GOOGLE_OAUTH_SETUP.md`](./GOOGLE_OAUTH_SETUP.md) - Para Google Login
- [`QA_FIXES_GUIDE.md`](./QA_FIXES_GUIDE.md) - Se algo não funcionar
- [`GIT_PUSH_GUIDE.md`](./GIT_PUSH_GUIDE.md) - Se tiver dúvida em git
